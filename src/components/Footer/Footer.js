        ...
        <div className="footer-logo-part">
          ...
          <div className="footer-text">
            ...
            <p className="text-light">
              ...
              pretium nunc sit nulla etiam. Dictum ut in ac interdum nulla
              nec. Sit iaculis non libero, quis. Porttitor aliquam nisl
              adipiscing amet felis viverra augue pharetra. Lorem ipsum dolor
              sit amet, consectetur adipiscing elit.
            </p>
          </div>
          <div className="footer-contact text-light">
            {/* flower manager contact */}
            <h5>Evliya Çelebi Mah. İstasyon Cad.
                Miraç Sk. No: 11 Tuzla / İSTANBUL-TURKEY</h5>
